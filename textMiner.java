...
System.out.println();for(ArrayList lo:frequent_itemsets)
{
...
temp1=temp1.replace("</body>","");temp1=temp1.replace("<body>","");
...
NodeList nodes = (NodeList) result;StringBuilder sb=new StringBuilder("");
...
System.out.print(newLine);tfidf(maplist);
}
/*The tfidf method
Return type:void
Input parameters:
...
{
BufferedReader br=new BufferedReader(new InputStreamReader(System.in));int min_supp=0,min_conf=0;
System.out.println();
